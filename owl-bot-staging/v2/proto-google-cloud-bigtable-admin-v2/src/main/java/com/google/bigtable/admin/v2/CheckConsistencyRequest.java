...
private static final long serialVersionUID = 0L;
  ...
  public enum ModeCase
    ...
    public static ModeCase forNumber(int value) {
      switch (value) {
        case 3: return STANDARD_READ_REMOTE_WRITES;
        case 4: return DATA_BOOST_READ_LOCAL_WRITES;
   ...
   */
  @java.lang.Override
  public com.google.bigtable.admin.v2.StandardReadRemoteWritesOrBuilder getStandardReadRemoteWritesOrBuilder() {
    if (modeCase_ == 3) {
       return (com.google.bigtable.admin.v2.StandardReadRemoteWrites) mode_;
    }
    return com.google.bigtable.admin.v2.StandardReadRemoteWrites.getDefaultInstance();
   ...
   */
  @java.lang.Override
  public com.google.bigtable.admin.v2.DataBoostReadLocalWritesOrBuilder getDataBoostReadLocalWritesOrBuilder() {
    if (modeCase_ == 4) {
       return (com.google.bigtable.admin.v2.DataBoostReadLocalWrites) mode_;
    }
    return com.google.bigtable.admin.v2.DataBoostReadLocalWrites.getDefaultInstance();
  ...
  public int getSerializedSize() {
    ...
    if (modeCase_ == 3) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(3, (com.google.bigtable.admin.v2.StandardReadRemoteWrites) mode_);
    }
    if (modeCase_ == 4) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(4, (com.google.bigtable.admin.v2.DataBoostReadLocalWrites) mode_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    switch (modeCase_) {
      case 3:
        if (!getStandardReadRemoteWrites()
            .equals(other.getStandardReadRemoteWrites())) return false;
        break;
      case 4:
        if (!getDataBoostReadLocalWrites()
            .equals(other.getDataBoostReadLocalWrites())) return false;
        break;
      case 0:
      default:
    }
  ...
  public static final class Builder extends
    ...
    private void buildPartialOneofs(com.google.bigtable.admin.v2.CheckConsistencyRequest result) {
      ...
      if (modeCase_ == 3 &&
          standardReadRemoteWritesBuilder_ != null) {
        result.mode_ = standardReadRemoteWritesBuilder_.build();
      }
      if (modeCase_ == 4 &&
          dataBoostReadLocalWritesBuilder_ != null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              input.readMessage(
                  getStandardReadRemoteWritesFieldBuilder().getBuilder(),
                  extensionRegistry);
              modeCase_ = 3;
              break;
            } // case 26
            case 34: {
              input.readMessage(
                  getDataBoostReadLocalWritesFieldBuilder().getBuilder(),
                  extensionRegistry);
              modeCase_ = 4;
              break;
            } // case 34
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.bigtable.admin.v2.StandardReadRemoteWrites, com.google.bigtable.admin.v2.StandardReadRemoteWrites.Builder, com.google.bigtable.admin.v2.StandardReadRemoteWritesOrBuilder> standardReadRemoteWritesBuilder_;
    /**
     * <pre>
     * Checks that reads using an app profile with `StandardIsolation` can
     * see all writes committed before the token was created, even if the
     ...
     * <code>.google.bigtable.admin.v2.StandardReadRemoteWrites standard_read_remote_writes = 3;</code>
     */
    public Builder setStandardReadRemoteWrites(com.google.bigtable.admin.v2.StandardReadRemoteWrites value) {
      if (standardReadRemoteWritesBuilder_ == null) {
        if (value == null) {
     ...
     * <code>.google.bigtable.admin.v2.StandardReadRemoteWrites standard_read_remote_writes = 3;</code>
     */
    public Builder mergeStandardReadRemoteWrites(com.google.bigtable.admin.v2.StandardReadRemoteWrites value) {
      if (standardReadRemoteWritesBuilder_ == null) {
        if (modeCase_ == 3 &&
            mode_ != com.google.bigtable.admin.v2.StandardReadRemoteWrites.getDefaultInstance()) {
          mode_ = com.google.bigtable.admin.v2.StandardReadRemoteWrites.newBuilder((com.google.bigtable.admin.v2.StandardReadRemoteWrites) mode_)
     ...
     * <code>.google.bigtable.admin.v2.StandardReadRemoteWrites standard_read_remote_writes = 3;</code>
     */
    public com.google.bigtable.admin.v2.StandardReadRemoteWrites.Builder getStandardReadRemoteWritesBuilder() {
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.bigtable.admin.v2.StandardReadRemoteWrites, com.google.bigtable.admin.v2.StandardReadRemoteWrites.Builder, com.google.bigtable.admin.v2.StandardReadRemoteWritesOrBuilder> 
        getStandardReadRemoteWritesFieldBuilder() {
      if (standardReadRemoteWritesBuilder_ == null) {
        if (!(modeCase_ == 3)) {
          mode_ = com.google.bigtable.admin.v2.StandardReadRemoteWrites.getDefaultInstance();
        }
        standardReadRemoteWritesBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.bigtable.admin.v2.StandardReadRemoteWrites, com.google.bigtable.admin.v2.StandardReadRemoteWrites.Builder, com.google.bigtable.admin.v2.StandardReadRemoteWritesOrBuilder>(
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.bigtable.admin.v2.DataBoostReadLocalWrites, com.google.bigtable.admin.v2.DataBoostReadLocalWrites.Builder, com.google.bigtable.admin.v2.DataBoostReadLocalWritesOrBuilder> dataBoostReadLocalWritesBuilder_;
    /**
     * <pre>
     * Checks that reads using an app profile with `DataBoostIsolationReadOnly`
     * can see all writes committed before the token was created, but only if
     ...
     * <code>.google.bigtable.admin.v2.DataBoostReadLocalWrites data_boost_read_local_writes = 4;</code>
     */
    public Builder setDataBoostReadLocalWrites(com.google.bigtable.admin.v2.DataBoostReadLocalWrites value) {
      if (dataBoostReadLocalWritesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.google.bigtable.admin.v2.DataBoostReadLocalWrites data_boost_read_local_writes = 4;</code>
     */
    public Builder mergeDataBoostReadLocalWrites(com.google.bigtable.admin.v2.DataBoostReadLocalWrites value) {
      if (dataBoostReadLocalWritesBuilder_ == null) {
        if (modeCase_ == 4 &&
            mode_ != com.google.bigtable.admin.v2.DataBoostReadLocalWrites.getDefaultInstance()) {
          mode_ = com.google.bigtable.admin.v2.DataBoostReadLocalWrites.newBuilder((com.google.bigtable.admin.v2.DataBoostReadLocalWrites) mode_)
              .mergeFrom(value).buildPartial();
        } else {
          mode_ = value;
        }
     ...
     * <code>.google.bigtable.admin.v2.DataBoostReadLocalWrites data_boost_read_local_writes = 4;</code>
     */
    public com.google.bigtable.admin.v2.DataBoostReadLocalWrites.Builder getDataBoostReadLocalWritesBuilder() {
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.bigtable.admin.v2.DataBoostReadLocalWrites, com.google.bigtable.admin.v2.DataBoostReadLocalWrites.Builder, com.google.bigtable.admin.v2.DataBoostReadLocalWritesOrBuilder> 
        getDataBoostReadLocalWritesFieldBuilder() {
      if (dataBoostReadLocalWritesBuilder_ == null) {
        if (!(modeCase_ == 4)) {
          mode_ = com.google.bigtable.admin.v2.DataBoostReadLocalWrites.getDefaultInstance();
        }
        dataBoostReadLocalWritesBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.bigtable.admin.v2.DataBoostReadLocalWrites, com.google.bigtable.admin.v2.DataBoostReadLocalWrites.Builder, com.google.bigtable.admin.v2.DataBoostReadLocalWritesOrBuilder>(
