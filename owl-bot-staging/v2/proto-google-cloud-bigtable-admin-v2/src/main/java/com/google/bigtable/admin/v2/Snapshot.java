...
private static final long serialVersionUID = 0L;
   ...
   * </pre>
   *
   * <code>.google.bigtable.admin.v2.Table source_table = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.bigtable.admin.v2.Snapshot.State state = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
  ...
  @java.lang.Override public com.google.bigtable.admin.v2.Snapshot.State getState() {
    com.google.bigtable.admin.v2.Snapshot.State result = com.google.bigtable.admin.v2.Snapshot.State.forNumber(state_);
