...
public interface AppProfileOrBuilder extends
   ...
   */
  @java.lang.Deprecated boolean hasPriority();
  /**
   * <pre>
   * This field has been deprecated in favor of `standard_isolation.priority`.
   * If you set this field, `standard_isolation.priority` will be set instead.
   ...
   * @return The priority.
   */
  @java.lang.Deprecated com.google.bigtable.admin.v2.AppProfile.Priority getPriority();
   ...
   */
  com.google.bigtable.admin.v2.AppProfile.DataBoostIsolationReadOnly getDataBoostIsolationReadOnly();
  /**
   * <pre>
   * Specifies that this app profile is intended for read-only usage via the
   * Data Boost feature.
   ...
   * <code>.google.bigtable.admin.v2.AppProfile.DataBoostIsolationReadOnly data_boost_isolation_read_only = 10;</code>
   */
  com.google.bigtable.admin.v2.AppProfile.DataBoostIsolationReadOnlyOrBuilder getDataBoostIsolationReadOnlyOrBuilder();
