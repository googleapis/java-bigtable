 ...
 *    </tr>
 *    <tr>
 *      <td>GenerateInitialChangeStreamPartitions</td>
 *      <td><p>NOTE: This API is intended to be used by Apache Beam BigtableIO.
 *  Returns the current list of partitions that make up the table's
 *  change stream. The union of partitions will cover the entire keyspace.
 *  Partitions can be read with `ReadChangeStream`.</p></td>
 *      <td>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>generateInitialChangeStreamPartitionsCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>ReadChangeStream</td>
 *      <td><p>NOTE: This API is intended to be used by Apache Beam BigtableIO.
