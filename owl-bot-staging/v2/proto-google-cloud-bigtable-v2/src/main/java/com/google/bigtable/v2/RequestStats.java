...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            com.google.bigtable.v2.ReadEfficiencyStats.Builder subBuilder = null;
            if (statsCase_ == 1) {
              subBuilder = ((com.google.bigtable.v2.ReadEfficiencyStats) stats_).toBuilder();
            }
            stats_ =
                input.readMessage(com.google.bigtable.v2.ReadEfficiencyStats.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.bigtable.v2.ReadEfficiencyStats) stats_);
          ...
          case 18: {
            com.google.bigtable.v2.AllReadStats.Builder subBuilder = null;
            if (statsCase_ == 2) {
              subBuilder = ((com.google.bigtable.v2.AllReadStats) stats_).toBuilder();
            }
            stats_ =
                input.readMessage(com.google.bigtable.v2.AllReadStats.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.bigtable.v2.AllReadStats) stats_);
              stats_ = subBuilder.buildPartial();
            }
            statsCase_ = 2;
            break;
  ...
  public enum StatsCase
    ...
    public static StatsCase forNumber(int value) {
      switch (value) {
        case 1: return READ_EFFICIENCY_STATS;
        case 2: return ALL_READ_STATS;
  ...
  public int getSerializedSize() {
    ...
    if (statsCase_ == 1) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, (com.google.bigtable.v2.ReadEfficiencyStats) stats_);
    }
    if (statsCase_ == 2) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(2, (com.google.bigtable.v2.AllReadStats) stats_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    switch (statsCase_) {
      case 1:
        if (!getReadEfficiencyStats()
            .equals(other.getReadEfficiencyStats())) return false;
        break;
      case 2:
        if (!getAllReadStats()
            .equals(other.getAllReadStats())) return false;
        break;
      case 0:
      default:
    }
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.bigtable.v2.RequestStats parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.bigtable.v2.RequestStats) e.getUnfinishedMessage();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.bigtable.v2.ReadEfficiencyStats, com.google.bigtable.v2.ReadEfficiencyStats.Builder, com.google.bigtable.v2.ReadEfficiencyStatsOrBuilder> readEfficiencyStatsBuilder_;
    /**
     * <pre>
     * Available with the
     * ReadRowsRequest.RequestStatsView.REQUEST_STATS_EFFICIENCY view, see
    ...
    public Builder mergeReadEfficiencyStats(com.google.bigtable.v2.ReadEfficiencyStats value) {
      if (readEfficiencyStatsBuilder_ == null) {
        if (statsCase_ == 1 &&
          ...
          stats_ = com.google.bigtable.v2.ReadEfficiencyStats.newBuilder((com.google.bigtable.v2.ReadEfficiencyStats) stats_)
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.bigtable.v2.ReadEfficiencyStats, com.google.bigtable.v2.ReadEfficiencyStats.Builder, com.google.bigtable.v2.ReadEfficiencyStatsOrBuilder> 
        getReadEfficiencyStatsFieldBuilder() {
      if (readEfficiencyStatsBuilder_ == null) {
        if (!(statsCase_ == 1)) {
          stats_ = com.google.bigtable.v2.ReadEfficiencyStats.getDefaultInstance();
        }
        readEfficiencyStatsBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.bigtable.v2.ReadEfficiencyStats, com.google.bigtable.v2.ReadEfficiencyStats.Builder, com.google.bigtable.v2.ReadEfficiencyStatsOrBuilder>(
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.bigtable.v2.AllReadStats, com.google.bigtable.v2.AllReadStats.Builder, com.google.bigtable.v2.AllReadStatsOrBuilder> allReadStatsBuilder_;
    /**
     * <pre>
     * Available with the ReadRowsRequest.RequestStatsView.REQUEST_STATS_FULL
     * view, see package google.bigtable.v2.
     ...
     * <code>.google.bigtable.v2.AllReadStats all_read_stats = 2;</code>
     */
    public Builder setAllReadStats(
        com.google.bigtable.v2.AllReadStats.Builder builderForValue) {
      if (allReadStatsBuilder_ == null) {
        stats_ = builderForValue.build();
        onChanged();
      } else {
    ...
    public Builder mergeAllReadStats(com.google.bigtable.v2.AllReadStats value) {
      if (allReadStatsBuilder_ == null) {
        if (statsCase_ == 2 &&
          ...
          stats_ = com.google.bigtable.v2.AllReadStats.newBuilder((com.google.bigtable.v2.AllReadStats) stats_)
              .mergeFrom(value).buildPartial();
        } else {
          stats_ = value;
        }
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.bigtable.v2.AllReadStats, com.google.bigtable.v2.AllReadStats.Builder, com.google.bigtable.v2.AllReadStatsOrBuilder> 
        getAllReadStatsFieldBuilder() {
      if (allReadStatsBuilder_ == null) {
        if (!(statsCase_ == 2)) {
          stats_ = com.google.bigtable.v2.AllReadStats.getDefaultInstance();
        }
        allReadStatsBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.bigtable.v2.AllReadStats, com.google.bigtable.v2.AllReadStats.Builder, com.google.bigtable.v2.AllReadStatsOrBuilder>(
  ...
  private static final com.google.protobuf.Parser<RequestStats>
    ...
    public RequestStats parsePartialFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new RequestStats(input, extensionRegistry);
    }
  };
