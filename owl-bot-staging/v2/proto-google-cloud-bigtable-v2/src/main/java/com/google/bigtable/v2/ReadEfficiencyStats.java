 ...
 */
public final class ReadEfficiencyStats extends
...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            readIteratorStats_ = input.readMessage(com.google.bigtable.v2.ReadIteratorStats.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 18: {
            ...
            requestLatencyStats_ = input.readMessage(com.google.bigtable.v2.RequestLatencyStats.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.bigtable.v2.RequestStatsProto.internal_static_google_bigtable_v2_ReadEfficiencyStats_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.google.bigtable.v2.RequestStatsProto.internal_static_google_bigtable_v2_ReadEfficiencyStats_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.bigtable.v2.ReadEfficiencyStats.class, com.google.bigtable.v2.ReadEfficiencyStats.Builder.class);
  }
  ...
  public com.google.bigtable.v2.ReadIteratorStats getReadIteratorStats() {
    return readIteratorStats_ == null ? com.google.bigtable.v2.ReadIteratorStats.getDefaultInstance() : readIteratorStats_;
  }
  /**
   * <pre>
   * Iteration stats describe how efficient the read is, e.g. comparing
  ...
  public int getSerializedSize() {
    ...
    if (readIteratorStats_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, getReadIteratorStats());
    }
    if (requestLatencyStats_ != null) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.bigtable.v2.ReadEfficiencyStats other = (com.google.bigtable.v2.ReadEfficiencyStats) obj;

    if (hasReadIteratorStats() != other.hasReadIteratorStats()) return false;
    if (hasReadIteratorStats()) {
      if (!getReadIteratorStats()
          .equals(other.getReadIteratorStats())) return false;
    }
  ...
  public static com.google.bigtable.v2.ReadEfficiencyStats parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    public com.google.bigtable.v2.ReadEfficiencyStats buildPartial() {
      com.google.bigtable.v2.ReadEfficiencyStats result = new com.google.bigtable.v2.ReadEfficiencyStats(this);
      if (readIteratorStatsBuilder_ == null) {
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.bigtable.v2.ReadIteratorStats, com.google.bigtable.v2.ReadIteratorStats.Builder, com.google.bigtable.v2.ReadIteratorStatsOrBuilder> readIteratorStatsBuilder_;
    /**
     * <pre>
     * Iteration stats describe how efficient the read is, e.g. comparing
     * rows seen vs. rows returned or cells seen vs cells returned can provide an
    ...
    public Builder mergeReadIteratorStats(com.google.bigtable.v2.ReadIteratorStats value) {
      if (readIteratorStatsBuilder_ == null) {
        if (readIteratorStats_ != null) {
          readIteratorStats_ =
            com.google.bigtable.v2.ReadIteratorStats.newBuilder(readIteratorStats_).mergeFrom(value).buildPartial();
        } else {
          readIteratorStats_ = value;
        }
        onChanged();
    ...
    public com.google.bigtable.v2.ReadIteratorStatsOrBuilder getReadIteratorStatsOrBuilder() {
      if (readIteratorStatsBuilder_ != null) {
        ...
        return readIteratorStats_ == null ?
            com.google.bigtable.v2.ReadIteratorStats.getDefaultInstance() : readIteratorStats_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.bigtable.v2.ReadIteratorStats, com.google.bigtable.v2.ReadIteratorStats.Builder, com.google.bigtable.v2.ReadIteratorStatsOrBuilder> 
        getReadIteratorStatsFieldBuilder() {
      if (readIteratorStatsBuilder_ == null) {
        readIteratorStatsBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.bigtable.v2.ReadIteratorStats, com.google.bigtable.v2.ReadIteratorStats.Builder, com.google.bigtable.v2.ReadIteratorStatsOrBuilder>(
  ...
  private static final com.google.protobuf.Parser<ReadEfficiencyStats>
      PARSER = new com.google.protobuf.AbstractParser<ReadEfficiencyStats>() {
    @java.lang.Override
