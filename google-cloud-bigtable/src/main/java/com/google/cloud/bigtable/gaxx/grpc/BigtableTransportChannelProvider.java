...
public final class BigtableTransportChannelProvider implements TransportChannelProvider {
  ...
  public TransportChannel getTransportChannel() throws IOException {
    ...
    ManagedChannel maybeDirectAccessChannel =
        (ManagedChannel) directAccessTransportChannel.getChannel();
    DirectAccessChecker directAccessChecker = new BigtableDirectAccessChecker(channelPrimer);
    ...
    if (isDirectAccessEligible) {
      ...
      preCreatedChannel = maybeDirectAccessChannel;
    } else {
      Map<String, String> fallbackHeaders = updateFeatureFlags(this.headers, false);
      maybeDirectAccessChannel.shutdownNow();
    ...
    BigtableChannelPool btChannelPool =
        BigtableChannelPool.create(
            btPoolSettings, channelFactory, channelPrimer, backgroundExecutor, preCreatedChannel);
