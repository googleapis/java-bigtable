...
import static com.google.bigtable.repackaged.io.opencensus.stats.Measure.MeasureLong;
...
public class BuiltinMeasureConstants {
    ...
    static final MeasureLong SERVER_LATENCIES = MeasureLong.create(
    ...
    static final MeasureLong CONNECTIVITY_ERROR_COUNT = MeasureLong.create(
    ...
    static final MeasureLong APPLICATION_LATENCIES = MeasureLong.create(
    ...
    static final MeasureLong THROTTLING_LATENCIES = MeasureLong.create(
