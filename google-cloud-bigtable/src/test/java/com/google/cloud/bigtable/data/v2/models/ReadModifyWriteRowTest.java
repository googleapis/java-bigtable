...
public class ReadModifyWriteRowTest {
  ...
  public void testAppend() {
    ...
    mutation =
        ReadModifyWriteRow.createForAuthorizedView(TABLE_ID, AUTHORIZED_VIEW_ID, "fake-key")
            .append(
                "fake-family",
                ByteString.copyFromUtf8("fake-qualifier"),
                ByteString.copyFromUtf8("fake-value"))
  ...
  public void fromProtoTest() {
    ...
    // Test ReadModifyWriteRow on an authorized view.
    expected =
        ReadModifyWriteRow.createForAuthorizedView(TABLE_ID, AUTHORIZED_VIEW_ID, "row-key")
            .increment("fake-family", ByteString.copyFromUtf8("fake-qualifier"), 1)
            .append("fake-family", "fake-qualifier", "fake-value");
