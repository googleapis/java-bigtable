  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "(bigtableadmin.googleapis.com/LogicalView\022Cprojects/{project}/insta"
          + "nces/{instance}/logicalViews/{logical_view}*\014logicalViews2\013logicalView\"\226\002\n"
          ...
          + "-bigtableadmin.googleapis.com/MaterializedView\022Mpro"
          + "jects/{project}/instances/{instance}/mat"
          + "erializedViews/{materialized_view}*\021materializedViews2\020materializedViewB\313\002\n"
          + "\034com.google.bigtable.admin.v2B\r"
          + "InstanceProtoP\001Z8cloud.google.com/go/bigtable/admin/ap"
          + "iv2/adminpb;adminpb\252\002\036Google.Cloud.Bigta"
          + "ble.Admin.V2\312\002\036Google\\Cloud\\Bigtable\\Adm"
          + "in\\V2\352\002\"Google::Cloud::Bigtable::Admin::V2\352Ax\n"
