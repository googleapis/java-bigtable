 ...
 *      <td><p> Returns the current list of partitions that make up the table's change stream. The union of partitions will cover the entire keyspace. Partitions can be read with `ReadChangeStream`. NOTE: This API is only intended to be used by Apache Beam BigtableIO.</td>
 *      <td>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 ...
 *      <td><p> Reads changes from a table's change stream. Changes will reflect both user-initiated mutations and mutations that are caused by garbage collection. NOTE: This API is only intended to be used by Apache Beam BigtableIO.</td>
 *      <td>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 ...
 *    </tr>
 *    <tr>
 *      <td><p> PrepareQuery</td>
 *      <td><p> Prepares a GoogleSQL query for execution on a particular Bigtable instance.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> prepareQuery(PrepareQueryRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> prepareQuery(InstanceName instanceName, String query)
 *           <li><p> prepareQuery(String instanceName, String query)
 *           <li><p> prepareQuery(InstanceName instanceName, String query, String appProfileId)
 *           <li><p> prepareQuery(String instanceName, String query, String appProfileId)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> prepareQueryCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> ExecuteQuery</td>
 *      <td><p> Executes a SQL query against a particular Bigtable instance.</td>
 *      <td>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
...
public class BaseBigtableDataClient implements BackgroundResource {
   ...
   *     results of later ones. At least one entry must be specified, and there can be at most
   *     100000 rules.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  ...
  // AUTO-GENERATED DOCUMENTATION AND METHOD.
  /**
   * Returns the current list of partitions that make up the table's change stream. The union of
   * partitions will cover the entire keyspace. Partitions can be read with `ReadChangeStream`.
  ...
  // AUTO-GENERATED DOCUMENTATION AND METHOD.
  /**
   * Reads changes from a table's change stream. Changes will reflect both user-initiated mutations
   * and mutations that are caused by garbage collection. NOTE: This API is only intended to be used
   ...
   *   PrepareQueryResponse response = baseBigtableDataClient.prepareQuery(instanceName, query);
   * }
   * }</pre>
   *
   * @param instanceName Required. The unique name of the instance against which the query should be
   *     executed. Values are of the form `projects/&lt;project&gt;/instances/&lt;instance&gt;`
   * @param query Required. The query string.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final PrepareQueryResponse prepareQuery(InstanceName instanceName, String query) {
    PrepareQueryRequest request =
        PrepareQueryRequest.newBuilder()
            .setInstanceName(instanceName == null ? null : instanceName.toString())
            .setQuery(query)
            .build();
    return prepareQuery(request);
  }
   ...
   * // https://cloud.google.com/java/docs/setup#configure_endpoints_for_the_client_library
   * try (BaseBigtableDataClient baseBigtableDataClient = BaseBigtableDataClient.create()) {
   *   String instanceName = InstanceName.of("[PROJECT]", "[INSTANCE]").toString();
   *   String query = "query107944136";
   *   PrepareQueryResponse response = baseBigtableDataClient.prepareQuery(instanceName, query);
   * }
   * }</pre>
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final PrepareQueryResponse prepareQuery(String instanceName, String query) {
    PrepareQueryRequest request =
        PrepareQueryRequest.newBuilder().setInstanceName(instanceName).setQuery(query).build();
    return prepareQuery(request);
  }
   ...
   *       baseBigtableDataClient.prepareQuery(instanceName, query, appProfileId);
   * }
   * }</pre>
   *
   * @param instanceName Required. The unique name of the instance against which the query should be
   *     executed. Values are of the form `projects/&lt;project&gt;/instances/&lt;instance&gt;`
   * @param query Required. The query string.
   * @param appProfileId Optional. This value specifies routing for preparing the query. Note that
   *     this `app_profile_id` is only used for preparing the query. The actual query execution will
   *     use the app profile specified in the `ExecuteQueryRequest`. If not specified, the `default`
   *     application profile will be used.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final PrepareQueryResponse prepareQuery(
      InstanceName instanceName, String query, String appProfileId) {
    PrepareQueryRequest request =
        PrepareQueryRequest.newBuilder()
            .setInstanceName(instanceName == null ? null : instanceName.toString())
            .setQuery(query)
   ...
   */
  public final PrepareQueryResponse prepareQuery(
      String instanceName, String query, String appProfileId) {
    PrepareQueryRequest request =
        PrepareQueryRequest.newBuilder()
   ...
   *           .build();
   *   PrepareQueryResponse response = baseBigtableDataClient.prepareQuery(request);
   * }
   * }</pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final PrepareQueryResponse prepareQuery(PrepareQueryRequest request) {
    return prepareQueryCallable().call(request);
  }
   ...
   * }</pre>
   */
  public final UnaryCallable<PrepareQueryRequest, PrepareQueryResponse> prepareQueryCallable() {
    return stub.prepareQueryCallable();
  }
   ...
   *           .setAppProfileId("appProfileId704923523")
   *           .setQuery("query107944136")
   *           .setPreparedQuery(ByteString.EMPTY)
