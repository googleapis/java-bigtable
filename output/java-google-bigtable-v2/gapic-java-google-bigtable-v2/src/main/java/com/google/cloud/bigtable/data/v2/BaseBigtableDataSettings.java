...
public class BaseBigtableDataSettings extends ClientSettings<BaseBigtableDataSettings> {
  ...
  public ServerStreamingCallSettings<
    ...
    return ((BigtableStubSettings) getStubSettings())
        .generateInitialChangeStreamPartitionsSettings();
  }
  ...
  public ServerStreamingCallSettings<ReadChangeStreamRequest, ReadChangeStreamResponse>
    ...
    return ((BigtableStubSettings) getStubSettings()).readChangeStreamSettings();
  }
  ...
  public UnaryCallSettings<PrepareQueryRequest, PrepareQueryResponse> prepareQuerySettings() {
    return ((BigtableStubSettings) getStubSettings()).prepareQuerySettings();
  }
  ...
  public ServerStreamingCallSettings<ExecuteQueryRequest, ExecuteQueryResponse>
    ...
    return ((BigtableStubSettings) getStubSettings()).executeQuerySettings();
  }
  ...
  public static class Builder extends ClientSettings.Builder<BaseBigtableDataSettings, Builder> {
    ...
    public ServerStreamingCallSettings.Builder<ReadChangeStreamRequest, ReadChangeStreamResponse>
        readChangeStreamSettings() {
      return getStubSettingsBuilder().readChangeStreamSettings();
    }
    ...
    public UnaryCallSettings.Builder<PrepareQueryRequest, PrepareQueryResponse>
      ...
      return getStubSettingsBuilder().prepareQuerySettings();
    }
    ...
    public ServerStreamingCallSettings.Builder<ExecuteQueryRequest, ExecuteQueryResponse>
        executeQuerySettings() {
      return getStubSettingsBuilder().executeQuerySettings();
    }
