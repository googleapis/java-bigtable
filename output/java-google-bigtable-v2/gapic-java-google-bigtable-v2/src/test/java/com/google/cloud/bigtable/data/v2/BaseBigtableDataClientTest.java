...
public class BaseBigtableDataClientTest {
  ...
  public void mutateRowsTest() throws Exception {
    MutateRowsResponse expectedResponse =
        MutateRowsResponse.newBuilder()
            ...
            .setRateLimitInfo(RateLimitInfo.newBuilder().build())
            .build();
    mockBigtable.addResponse(expectedResponse);
  ...
  @Test
  public void prepareQueryTest() throws Exception {
    PrepareQueryResponse expectedResponse =
        PrepareQueryResponse.newBuilder()
            .setMetadata(ResultSetMetadata.newBuilder().build())
            .setPreparedQuery(ByteString.EMPTY)
            .setValidUntil(Timestamp.newBuilder().build())
            .build();
    mockBigtable.addResponse(expectedResponse);
    ...
    PrepareQueryResponse actualResponse = client.prepareQuery(instanceName, query);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<AbstractMessage> actualRequests = mockBigtable.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    PrepareQueryRequest actualRequest = ((PrepareQueryRequest) actualRequests.get(0));

    Assert.assertEquals(instanceName.toString(), actualRequest.getInstanceName());
  ...
  @Test
  public void prepareQueryExceptionTest() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockBigtable.addException(exception);
    ...
    try {
      InstanceName instanceName = InstanceName.of("[PROJECT]", "[INSTANCE]");
      String query = "query107944136";
      client.prepareQuery(instanceName, query);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
  ...
  @Test
  public void prepareQueryTest2() throws Exception {
    PrepareQueryResponse expectedResponse =
        PrepareQueryResponse.newBuilder()
            .setMetadata(ResultSetMetadata.newBuilder().build())
            .setPreparedQuery(ByteString.EMPTY)
    ...
    String instanceName = "instanceName-737857344";
    String query = "query107944136";
    ...
    Assert.assertEquals(instanceName, actualRequest.getInstanceName());
    Assert.assertEquals(query, actualRequest.getQuery());
    Assert.assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
  ...
  @Test
  public void prepareQueryExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockBigtable.addException(exception);
  ...
  @Test
  public void prepareQueryTest3() throws Exception {
    PrepareQueryResponse expectedResponse =
        PrepareQueryResponse.newBuilder()
            .setMetadata(ResultSetMetadata.newBuilder().build())
            .setPreparedQuery(ByteString.EMPTY)
    ...
    PrepareQueryResponse actualResponse = client.prepareQuery(instanceName, query, appProfileId);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  public void prepareQueryExceptionTest3() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockBigtable.addException(exception);
    ...
    try {
      ...
      String query = "query107944136";
      String appProfileId = "appProfileId704923523";
      client.prepareQuery(instanceName, query, appProfileId);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
  ...
  @Test
  public void prepareQueryTest4() throws Exception {
    PrepareQueryResponse expectedResponse =
        PrepareQueryResponse.newBuilder()
            .setMetadata(ResultSetMetadata.newBuilder().build())
            .setPreparedQuery(ByteString.EMPTY)
  ...
  @Test
  public void prepareQueryExceptionTest4() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockBigtable.addException(exception);
  ...
  public void executeQueryTest() throws Exception {
    ExecuteQueryResponse expectedResponse = ExecuteQueryResponse.newBuilder().build();
    mockBigtable.addResponse(expectedResponse);
    ...
    MockStreamObserver<ExecuteQueryResponse> responseObserver = new MockStreamObserver<>();

    ServerStreamingCallable<ExecuteQueryRequest, ExecuteQueryResponse> callable =
        client.executeQueryCallable();
    callable.serverStreamingCall(request, responseObserver);

    List<ExecuteQueryResponse> actualResponses = responseObserver.future().get();
    Assert.assertEquals(1, actualResponses.size());
    Assert.assertEquals(expectedResponse, actualResponses.get(0));
  }
