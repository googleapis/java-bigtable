...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              input.readMessage(
                  getServerStatsFieldBuilder().getBuilder(),
                  extensionRegistry);
     ...
     */
    public boolean hasServerStats() {
      return serverStatsBuilder_ != null || serverStats_ != null;
    }
    /**
     * <code>.google.bigtable.v2.ServerStats server_stats = 2;</code>
     * @return The serverStats.
    ...
    public Builder mergeServerStats(com.google.bigtable.v2.ServerStats value) {
      if (serverStatsBuilder_ == null) {
        if (serverStats_ != null) {
          serverStats_ =
            com.google.bigtable.v2.ServerStats.newBuilder(serverStats_).mergeFrom(value).buildPartial();
        } else {
          serverStats_ = value;
        }
        onChanged();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
      ...
      if (serverStatsBuilder_ == null) {
        serverStatsBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.bigtable.v2.ServerStats, com.google.bigtable.v2.ServerStats.Builder, com.google.bigtable.v2.ServerStatsOrBuilder>(
                getServerStats(),
                getParentForChildren(),
                isClean());
