...
```Groovy
implementation 'com.google.cloud:google-cloud-bigtable:2.67.2'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-bigtable" % "2.67.2"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-bigtable/2.67.2
