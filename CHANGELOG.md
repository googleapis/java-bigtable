...
* Add min, max, hll aggregators and more types ([0ce8a2a](https://github.com/googleapis/java-bigtable/commit/0ce8a2a38703233da58208655f41f6e81e03576e))
...
* publish Automated Backups protos ([e7f03fc](https://github.com/googleapis/java-bigtable/commit/e7f03fc7d252a7ff6c76a8e6e0a9e6ad3dcbd9d5))
...
* publish ProtoRows Message ([0ce8a2a](https://github.com/googleapis/java-bigtable/commit/0ce8a2a38703233da58208655f41f6e81e03576e))
...
* publish the Cloud Bigtable ExecuteQuery API ([0ce8a2a](https://github.com/googleapis/java-bigtable/commit/0ce8a2a38703233da58208655f41f6e81e03576e))
...
* update Go Bigtable import path ([0ce8a2a](https://github.com/googleapis/java-bigtable/commit/0ce8a2a38703233da58208655f41f6e81e03576e))
* update Go Datastore import path ([0ce8a2a](https://github.com/googleapis/java-bigtable/commit/0ce8a2a38703233da58208655f41f6e81e03576e))
...
* **deps:** Update the Java code generator (gapic-generator-java) to 2.39.0 ([e7f03fc](https://github.com/googleapis/java-bigtable/commit/e7f03fc7d252a7ff6c76a8e6e0a9e6ad3dcbd9d5))
...
* **deps:** update the Java code generator (gapic-generator-java) to 2.65.0-rc1 ([2b1d201](https://github.com/googleapis/java-bigtable/commit/2b1d201d56540cdb45b65b4ed2a1c786a519d3a0))
...
* Update gapic-libraries-bom version to 1.76.0-rc1 ([#2742](https://github.com/googleapis/java-bigtable/issues/2742)) ([9be7f2f](https://github.com/googleapis/java-bigtable/commit/9be7f2f8b388267f8a1d058debeba5443675fb43))
...
* Corrected various type documentation ([0ce8a2a](https://github.com/googleapis/java-bigtable/commit/0ce8a2a38703233da58208655f41f6e81e03576e))
...
* The field `table_name` in message `.google.bigtable.v2.CheckAndMutateRowRequest` is changed from required to optional ([ae89709](https://github.com/googleapis/java-bigtable/commit/ae89709514921f7f362b7bf6057ec2f01e50046d))
* The field `table_name` in message `.google.bigtable.v2.MutateRowRequest` is changed from required to optional ([ae89709](https://github.com/googleapis/java-bigtable/commit/ae89709514921f7f362b7bf6057ec2f01e50046d))
* The field `table_name` in message `.google.bigtable.v2.MutateRowsRequest` is changed from required to optional ([ae89709](https://github.com/googleapis/java-bigtable/commit/ae89709514921f7f362b7bf6057ec2f01e50046d))
* The field `table_name` in message `.google.bigtable.v2.ReadModifyWriteRowRequest` is changed from required to optional ([ae89709](https://github.com/googleapis/java-bigtable/commit/ae89709514921f7f362b7bf6057ec2f01e50046d))
* The field `table_name` in message `.google.bigtable.v2.ReadRowsRequest` is changed from required to optional ([ae89709](https://github.com/googleapis/java-bigtable/commit/ae89709514921f7f362b7bf6057ec2f01e50046d))
* The field `table_name` in message `.google.bigtable.v2.SampleRowKeysRequest` is changed from required to optional ([ae89709](https://github.com/googleapis/java-bigtable/commit/ae89709514921f7f362b7bf6057ec2f01e50046d))
